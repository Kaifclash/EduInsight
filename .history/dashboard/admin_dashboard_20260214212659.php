  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <div class="nav">
        ...
        <a href="students.php">Manage Students <span class="pill">Open</span></a>        
        <a href="#" onclick="return comingSoon('Teachers');">Manage Teachers <span class="pill">Optional</span></a>       <a href="exams.php">Exams</a>
